...
fn main() {
    ...
    for i in 1..n {
        for j in 1..n {
            dp[i as usize][j as usize][0] += min(
                dp[i as usize - 1usize][j as usize][0],
                dp[i as usize][j as usize - 1usize][0],
            );
            dp[i as usize][j as usize][1] += min(
                dp[i as usize - 1usize][j as usize][1],
                dp[i as usize][j as usize - 1usize][1],
            );
        }
    }
